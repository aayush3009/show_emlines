...
lines_lim = [1215.7, 1549., 1650., 1909., 2800., 3727., 3868.8, 3967.5, 4101.7, 4340.5, 4363.2,
         4861.3, 4958.9, 5007, 6562.8, 6583.4, 6716., 6731., 
         9069., 9531.1, 10830.340, 10938, 12820, 18750]
names_lim = [r"Ly$\alpha$", "CIV", "HeII+OIII]", "CIII]", "MgII", "[OII]", "[NeIII]", "[NeIII]", r"H$\delta$", r"H$\gamma$", "[OIII]",
...
def show_restlines(lines=lines_lim, names=names_lim, min_wave=1000, max_wave=9500, c='k', ypos=2.2e-20, xoffset=0.02e4, lnames=False, alpha=0.3, fontsize=8):
    for i in range(len(lines)):
